...
<div class="bg-gray-200 min-h-screen pb-24">
    ...
    <div class="container mx-auto max-w-3xl mt-8">
      ...
      <h1 class="text-2xl font-bold text-gray-700 px-6 md:px-0">Website Settings</h1>
      ...
      <form action="{{ route('setting.save') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="w-full bg-white rounded-lg mx-auto mt-8 flex overflow-hidden rounded-b-none">
          <div class="w-1/3 bg-gray-100 p-8 hidden md:inline-block">
            <h2 class="font-medium text-md text-gray-700 mb-4 tracking-wide">Info</h2>
          ...
          <div class="md:w-2/3 w-full">
            ...
            <div class="py-8 px-16">
                <label for="name" class="text-sm text-gray-800">Price</label>
                <input class="mt-2 border-2 border-gray-200 px-3 py-2 block w-full rounded-lg text-base text-gray-900 focus:outline-none focus:border-indigo-500" type="text" value="{{ $setting->price }}" name="price">
              </div>
        ...
        <div class="p-16 py-8 bg-gray-300 clearfix rounded-b-lg border-t border-gray-200">
          ...
          <input type="submit" class="bg-indigo-600 hover:bg-purple-700 text-white text-sm font-medium px-6 py-2 rounded float-right uppercase cursor-pointer" value="Save">
        </div>
      </form>
    </div>
  </div>
